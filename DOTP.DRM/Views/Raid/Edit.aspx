...
<asp:Content ID="TitleContent" ContentPlaceHolderID="TitleContent" runat="server">DRM - Raid - Edit</asp:Content>
...
<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadContent" runat="server">
 ...
 <script src="/Scripts/EditRaid.js" type="text/javascript"></script>
...
<asp:Content ID="StatusContent" ContentPlaceHolderID="StatusContent" runat="server">
 <div class="errorPanel" id="errorPanel" style="display: none;">
  <h2>Unable to edit the raid. Please correct the error and try again:</h2>
  <p id="errorContent"></p>
 </div>
 <div class="successPanel" id="successPanel" style="display: none">
  The raid was successfully modified. <%: Html.ActionLink("Go back to the raid list.", "Index", "Home") %>
 </div>
</asp:Content>
...
<% using( Html.BeginForm("Edit", "Raid", FormMethod.Post, new { id = "editForm" }) ) { %>
